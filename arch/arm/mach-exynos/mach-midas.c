...
#else
	.in_curr_limit = 1200, /* por defecto 1000 */
	.chg_curr_ta = 1200, /* por defecto 1000 */
	.chg_curr_dock = 1200, /* por defecto 1000 */
	.chg_curr_siop_lv1 = 475,
	.chg_curr_siop_lv2 = 475,
	.chg_curr_siop_lv3 = 475,
#endif

	.chg_curr_usb = 900, /* por defecto 475 */
	.chg_curr_cdp = 1000,
#if defined(CONFIG_MACH_T0_USA_VZW)
	.chg_curr_wpc = 900, /* por defecto 650 */
#else
	.chg_curr_wpc = 900, /* por defecto 475 */
#endif
	.chg_curr_etc = 900, /* por defecto 475 */
